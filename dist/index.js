...
(() => {
  ...
  var WEBETU = "https://webetu.iutnc.univ-lorraine.fr";
  ...
  var gallery;
  function load() {
    return loadResource(API + "/photos").then((data) => {
      gallery = data;
      return data;
    });
  }
  function getPage(name) {
    return loadResource(gallery.links[name].href).then((data) => {
      gallery = data;
      return data;
    });
  }
  ...
  function displayGallery(data, callback) {
    const source = document.querySelector(
      "#galleryTemplate"
    ).innerHTML;
